...
NoteOnEvent and NoteOffEvent renamed to NoteOn and NoteOff.

Removed boolean Event methods like meta? and note?. Use the event classes
themselves (for example, MIDI::MetaEvent === my_event or
